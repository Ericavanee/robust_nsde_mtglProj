...
if __name__ == '__main__':
    ...
    model = Net_LSV(dim=1, timegrid=timegrid, strikes_call=strikes_call, n_layers=args.n_layers,
    ...
    # to load
    #checkpoint = torch.load('Neural_SDE_exp0_nobound_maturity32_AugmentedLagrangian.pth.tar')
    #model.load_state_dict(checkpoint['state_dict'])
    #print(checkpoint)
    #optimizer.load_state_dict(checkpoint['optimizer'])
    # generate prices
    #forward(self, S0, z, MC_samples, ind_T, period_length=30):
    #S0, batch_z, batch_size, T,
    #period_length = 16
    #n_steps = 96
    ...
    np.savetxt('stock_traj.txt', a[0].numpy())